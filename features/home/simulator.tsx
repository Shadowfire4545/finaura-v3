    ...
    return (
        ...
        >
            <div className="flex flex-col w-full max-w-300 gap-4">
                <h2 className="text-3xl font-medium tracking-widest -mt-8 text_purple">Más de $5,000 millones otorgados en préstamos en línea</h2>
                <h3 className="text-xl font-normal italic mb-6 text_light_purple">Más de 4 millones de personas han confiado en nosotros.</h3>
                <div className="flex flex-col md:flex-row w-full gap-8">                
                    {/* Datos del simulador */}
                    <div className="flex flex-col items-start justify-start gap-4 w-full md:w-1/3 py-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 w-full md:gap-3">
                            {cardsTemp.map((card, index) => (
                                ...
                                >
                                    ...
                                    <span className="text-sm lg:text-lg tracking-wide font-medium text-default-700 whitespace-nowrap">{card.monthlyPayment}<span className="text-xs lg:text-sm"> / mes</span></span>
                                </div>
                            ))}
                        </div>
