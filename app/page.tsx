    ...
    <>
        ...
        <div className="w-full max-w-300 flex flex-col items-center justify-start gap-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 md:gap-4">
            {benefitsData.map((benefit, index) => {
              ...
              return (
                <div key={index} className="flex md:flex-col items-center md:justify-between gap-2 p-4 h-full">
                  ...
                  <div className="flex flex-col h-full gap-1 text-start md:text-center">
                    <h3 className="text-base md:text-lg font-bold text_purple tracking-wide">{benefit.title}</h3>
      ...
      >
        <div className="w-full max-w-300 flex flex-col items-center gap-6">
          <h2 className="text-2xl md:text-3xl 2xl:text-4xl tracking-widest text-start md:text-center font-medium text_purple">Requisitos para obtener un préstamo en línea</h2>
          <div className="w-full flex flex-col md:flex-row items-center justify-center">
            <div className="w-auto md:w-1/2 h-50 md:h-80">
              <div className="w-50 md:w-80 h-50 md:h-80 relative mx-auto rounded-full">
                <Image
                    ...
                    <div key={index} className="flex flex-col items-start justify-between gap-3 p-4 h-full">
                      <div className="flex items-center">
                        <span className="p-3 bg-[#41C7B5]/80 rounded-xl mr-2">
                          {Icon && <Icon className="text-default-100 w-5 h-5"/>}
                        </span>
        ...
        <div className="w-full max-w-300 flex flex-col items-center">
          <div className="w-full flex items-center justify-center">
            ...
            <div className="w-full md:w-1/2 gap-4 flex flex-col">
              <h2 className="text-3xl md:text-4xl font-medium font-serif text_purple tracking-wider">¿Es seguro pedir un préstamo en línea en finaura?</h2>          
      ...
      >
        <div className="w-full max-w-300 flex flex-col items-center justify-start gap-8">
          <h2 className="text-2xl md:text-3xl 2xl:text-4xl font-medium tracking-widest text-start md:text-center md:px-16 text_purple">Préstamos en línea: estos son nuestros resultados</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 md:gap-4">
            {benefitsData.map((benefit, index) => {
              const Icon = benefit.icon;
              return (
